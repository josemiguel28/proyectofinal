    ...
    <div class="w-full flex flex-wrap items-center justify-evenly mx-auto p-4">
        ...
        <div class="md:order-2">
            ...
            <a href="index.php?page=Sec_Login">
                <button type="button"
                        class="text-white bg-terciary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Ingresar
...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{~CURRENT_YEAR}} <a href="#"
                                                                                                       class="hover:underline">Digital Games™</a>. All Rights Reserved.
          </span>
